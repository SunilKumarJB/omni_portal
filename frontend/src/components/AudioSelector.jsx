...
export default function AudioSelector({ selectedAudio, setSelectedAudio, audioFile, setAudioFile }) {
  ...
  function selectPreset(a) {
    setSelectedAudio(a)
    setAudioFile(null); setRecBlob(null); setUploadUrl(null)
  }
  ...
  function handleUpload(file) {
    ...
    setAudioFile(file); setSelectedAudio(null); setRecBlob(null)
  }
        ...
        <div className="max-w-xs mx-auto text-center">
          {!recBlob ? (
            ...
            <div className="g-card space-y-4">
              ...
              <button
                onClick={() => { setRecBlob(null); setAudioFile(null); setRecTime(0) }}
        ...
        >
          {!uploadUrl ? (
            ...
            <div className="py-6 px-6 space-y-3">
              ...
              <audio src={uploadUrl} controls className="w-full h-8" onClick={e => e.stopPropagation()} />
            </div>
          )}
