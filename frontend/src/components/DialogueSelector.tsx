...
const DIALOGUES: Record<string, Record<LanguageCode, string>> = {
  upside_down_cup: {
    en: "Hi, I'm [Character_Name]. Why follow gravity? Flip your perspective and sip in style. The Upside Down Cup.",
    hi: 'नमस्ते, मैं [Character_Name] हूँ। गुरुत्वाकर्षण क्यों मानें? अपना नज़रिया बदलें और स्टाइल से घूंट लें। द अपसाइड डाउन कप।',
    ta: 'வணக்கம், நான் [Character_Name]. ஈர்ப்பு விசையை ஏன் பின்பற்ற வேண்டும்? உங்கள் பார்வையை மாற்றி ஸ்டைலாக பருகுங்கள். தி அப்சைடு டவுன் கப்.',
    te: 'నమస్తే, నేను [Character_Name]. గురుత్వాకర్షణను ఎందుకు అనుసరించాలి? మీ కోణాన్ని మార్చండి మరియు శైలితో ఆస్వాదించండి. ది అప్సైడ్ డౌన్ కప్.',
    kn: 'ನಮಸ್ತೆ, ನಾನು [Character_Name]. ಗುರುತ್ವಾಕರ್ಷಣೆಯನ್ನು ಏಕೆ ಪಾಲಿಸಬೇಕು? ನಿಮ್ಮ ದೃಷ್ಟಿಕೋನವನ್ನು ಬದಲಾಯಿಸಿ ಮತ್ತು ಶೈಲಿಯಿಂದ ಕುಡಿಯಿರಿ. ದಿ ಅಪ್‌ಸೈಡ್ ಡೌನ್ ಕಪ್.',
    ml: 'നമസ്കാരം, ഞാൻ [Character_Name]. ഗുരുതുവാകർഷണം എന്തിന് പിന്തുടരണം? നിങ്ങളുടെ വീക്ഷണം മാറ്റി സ്റ്റൈലിൽ കുടിക്കൂ. ദി അപ്സൈഡ് ഡൗൺ കപ്പ്.',
    bn: 'নমস্কার, আমি [Character_Name]। মাধ্যাকর্ষণ কেন মানবেন? আপনার দৃষ্টিভঙ্গি ঘুরিয়ে দিন এবং স্টাইলে চুমুক দিন। দ্য আপসাইড ডাউন কাপ।',
    mr: 'नमस्कार, मी [Character_Name]. गुरुत्वाकर्षण कशासाठी पाळायचं? आपला दृष्टिकोन बदला आणि दिमाखात घोट घ्या. द अपसाइड डाऊन कप.',
    gu: 'નમસ્તે, હું [Character_Name] છું. ગુરુત્વાકર્ષણ શા માટે માનવું? તમારો દ્રષ્ટિકોણ બદલો અને સ્ટાઇલમાં ઘૂંટડો લો. ધ અપસાઇડ ડાઉન કપ.',
    pa: 'ਸਤਿ ਸ੍ਰੀ ਅਕਾਲ, ਮੈਂ [Character_Name] ਹਾਂ। ਗੁਰੂਤਾਕਰਸ਼ਣ ਦੀ ਪਾਲਣਾ ਕਿਉਂ ਕਰੀਏ? ਆਪਣਾ ਨਜ਼ਰੀਆ ਬਦਲੋ ਅਤੇ ਸਟਾਈਲ ਨਾਲ ਚੁਸਕੀ ਲਓ। ਦ ਅਪਸਾਈਡ ਡਾਊਨ ਕੱਪ।',
  },
  aggressive_toaster: {
  ...
  musical_toothbrush: {
    en: "Hi, I'm [Character_Name]. Brushing your teeth shouldn't be boring. Turn it into a stadium concert. Musical Toothbrush.",
    hi: 'नमस्ते, मैं [Character_Name] हूँ। ब्रश करना उबाऊ नहीं होना चाहिए। इसे एक स्टेडियम कॉन्सर्ट में बदलें। म्यूजिकल टूथब्रश।',
    ta: 'வணக்கம், நான் [Character_Name]. பல் துலக்குவது சலிப்பாக இருக்கக்கூடாது. அதை ஒரு அரங்கு இசை நிகழ்ச்சியாக மாற்றுங்கள். மியூசிகல் டூத்பிரஷ்.',
    te: 'నమస్తే, నేను [Character_Name]. బ్రషింగ్ బోర్ కొట్టకూడదు. దానిని ఒక స్టేడియం కచేరీగా మార్చండి. మ్యూజికల్ టూత్ బ్రష్.',
    kn: 'ನಮಸ್ತೆ, ನಾನು [Character_Name]. ಹಲ್ಲುಜ್ಜುವುದು ಬೇಸರ ತರಬಾರದು. ಅದನ್ನು ಸ್ಟೇಡಿಯಂ ಕಾನ್ಸರ್ಟ್ ಆಗಿ ಬದಲಾಯಿಸಿ. ಮ್ಯೂಸಿಕಲ್ ಟೂತ್‌ಬ್ರಷ್.',
    ml: 'നമസ്കാരം, ഞാൻ [Character_Name]. പല്ല് തേപ്പ് വിരസമാകരുത്. അതിനെ ഒരു സ്റ്റേഡിയം സംഗീത പരിപാടിയാക്കി മാറ്റൂ. മ്യൂസിക്കൽ ടൂത്ത് ബ്രഷ്.',
    bn: 'নমস্কার, আমি [Character_Name]। ব্রাশ করা বিরক্তিকর হওয়া উচিত নয়। একে স্টেডিয়ামের কনসার্টে পরিণত করুন। মিউজিক্যাল টুথব্রাশ।',
    mr: 'नमस्कार, मी [Character_Name]. ब्रश करणं कंटाळवाणं नसावं. त्याला स्टेडियम कॉन्सर्ट बनवा. म्युझिकल टूथब्रश.',
    gu: 'નમસ્તે, હું [Character_Name] છું. બ્રશ કરવું કંટાળાજનક ન હોવું જોઈએ. તેને સ્ટેડિયમ કોન્સર્ટમાં ફેરવો. મ્યુઝિકલ ટૂથબ્રશ.',
    pa: 'ਸਤਿ ਸ੍ਰੀ ਅਕਾਲ, ਮੈਂ [Character_Name] ਹਾਂ। ਬਰੱਸ਼ ਕਰਨਾ ਬੋਰਿੰਗ ਨਹੀਂ ਹੋਣਾ ਚਾਹੀਦਾ। ਇਸਨੂੰ ਇੱਕ ਸਟੇਡੀਅਮ ਕੰਸਰਟ ਵਿੱਚ ਬਦਲੋ। ਮਿਊਜ਼ੀਕਲ ਟੂਥਬਰੱਸ਼।',
  },
  snooze_blanket: {
