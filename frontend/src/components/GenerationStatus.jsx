  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm space-y-8">
        ...
        {/* Timer */}
        <div className="text-center text-xs text-[rgba(255,255,255,0.30)] font-mono">{fmt(elapsed)} elapsed</div>

        {/* QR preview */}
        {requestData?.qr_code_url && (
          <div className="g-card text-center space-y-2">
            <p className="text-xs text-[rgba(255,255,255,0.40)]">QR code ready — scan to open when complete</p>
