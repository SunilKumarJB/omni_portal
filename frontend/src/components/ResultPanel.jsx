          ...
          <Card className="space-y-4 p-5 text-center">
            <div>
              <p className="mb-1 text-sm font-semibold text-foreground">
                {isDone ? 'Scan to view & download' : 'Omni is fabricating…'}
              </p>
              <p className="text-xs text-muted-foreground">
                {isDone ? 'Video is ready on any device' : 'Generating scenes and compiling audio'}
              </p>
            </div>
            ...
            {isDone ? (
              ...
              /* High-fidelity glowing, swirling Google colors orb animation */
              <div className="mx-auto flex h-52 w-52 items-center justify-center">
                <div className="orb-container">
                  {/* Swirling brand color blobs */}
                  ...
                  {/* Bright central glowing core */}
                  <div className="orb-core" />

                  {/* Glass lens overlay with minimalist progress badge */}
                  <div className="absolute h-16 w-16 rounded-full border border-white/10 bg-black/40 backdrop-blur-md shadow-lg flex flex-col items-center justify-center z-10">
                    <span className="text-[7px] font-extrabold tracking-[0.25em] text-white/50 uppercase leading-none mb-0.5">
                      rendering
                    </span>
                    <span className="text-xs font-bold tracking-tight text-white/90 tabular-nums leading-none">
                      {data.progress ?? 0}%
                    </span>
                  </div>
                </div>
